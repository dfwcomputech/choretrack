...
interface EditChildAccountFormProps {
  ...
  initialValues: UpdateChildAccountPayload
  onClose: () => void
  onSubmit: (payload: UpdateChildAccountPayload) => Promise<void>
}
...
export default function EditChildAccountForm({
  ...
  const handleInputChange = (field: keyof UpdateChildAccountPayload, value: string) => {
